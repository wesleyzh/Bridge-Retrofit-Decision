...
class MitigationSolution(Solution):
    ...
    def evaluate_solution(self):
        ...
        self.objectives[0] =  -1 * Total_Expected_EIPW / float(num_pair) + budget_penalty #first objective value, nsga2 by default is to minimize
        ...
        self.objectives[1] = math.sqrt(difference) + budget_penalty
        
        print - 1 * self.objectives[0], self.objectives[1]
        
        csv_file0.write("" + str(self.objectives[0]) + ", " + str(self.objectives[1]) + "\n")
...
csv_file0 = open('nsga2_all.csv', 'w')
csv_file0.write("" + "AverageEIPW" + "," + "DifferenceEIPW" + "\n")
...
csv_file.write("" + "AverageEIPW" + "," + "DifferenceEIPW" + "\n")
    
for i in range(len(P)):
    if P[i].objectives[0] < 0 and P[i].objectives[1] < 10:
        csv_file.write("" + str(-1*P[i].objectives[0]) + ", " + str(P[i].objectives[1]) + "\n")
